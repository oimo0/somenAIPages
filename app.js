...
$('#logout').onclick=safe(async()=>{await api('/logout','POST',{});stopScanner();authScreen(false);usageState=null;authToken='';localStorage.removeItem('somenai-token');current=null;chats=[];conversation=[];render();renderHistory();$('#username').textContent='ゲスト';$('#auth').showModal();});
